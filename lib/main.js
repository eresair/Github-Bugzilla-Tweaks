...
const bzUIURL = "https://bugzilla.songbirdnest.com";
//const bzUIURL = "https://landfill.bugzilla.org";

const attachmentDetailsURL = "https://bugzilla.songbirdnest.com/attachment.cgi?action=edit&id=";
  ...
  onAttach: function onAttach(worker, mod) {
    worker.on('message', function(msg) {
      if (msg.bug)
        ...
        require('tabs').open('https://bugzilla.songbirdnest.com/enter_bug.cgi');
    });
  }
});
    ...
    Bugzilla.ajax({
      ...
      success: function(data) {
        require("notifications").notify({
          title: "Success!",
          text: "Your pull request was successfully posted as an attachment to bug " + bug + " on bugzilla.songbirdnest.com. Forwarding..."
        });
      ...
      error: function(data) {
        require("notifications").notify({
          title: "Failure!",
          text: "Your pull request was not successfully posted as an attachment to bug " + bug + " on bugzilla.songbirdnest.com."
        });
      }
    });
  });
